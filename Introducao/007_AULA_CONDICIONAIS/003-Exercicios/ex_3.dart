...
void main() {
  final num1 = lerNumero('Digite o primeiro número: ');
  stdout.write('Digite o operador (+, -, *, /): ');
  final operador = (stdin.readLineSync() ?? '').trim();
  final num2 = lerNumero('Digite o segundo número: ');
  ...
  final resultado = switch (operador) {
    '+' => num1 + num2,
    '-' => num1 - num2,
    '*' => num1 * num2,
  ...
  if (resultado == null && operador != '/' && num2 != 0) {
    print('Erro: operador inválido ($operador). Use +, -, *, /.');
    return;
  }
